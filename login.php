...
<title>Client Area - <?=$mofh['title'];?></title>
...
<div class="login-box">
<a href="<?=$mofh['domain'];?>">
<p style="text-align:center"><img src="<?=$mofh['logo'];?>" alt="<?=$mofh['title'];?>" align="center" /></p>
</a>
<div class="card">
<div class="body">
<div class="msg">Login to your account</div>
<form action="<?=$mofh['cpanel'];?>/login.php" method="post" name="login">
<div class="input-group form-float">
<span class="input-group-addon">
<i class="material-icons">person</i>
</span>
