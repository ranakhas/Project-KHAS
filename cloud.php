...
<!-- 
				...
				<div class="col-sm-12">
					<div class="wrapper">
						...
						<div class="subheding">
							...
							<a href="cloud.php" class="link active">Cloud Hosting</a>
						</div>
					</div>
				</div>
			</div>
	...
	****************** 
	...
	<div class="mofh-cloud">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<div class="section-heading small-text">Deploy a cloud server on us.</div>
					<div class="section-subheading small-text">
						Spin up Cloud cloud servers with industry leading price-performance and predictable costs. Try Cloud Hosting free for 60 days. 
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 col-sm-6">
					<div class="wrapper">
						<div class="img-wrap">
							<img src="img/cloud-1.jpg" alt="photo" class="img img-responsive">
							<div class="number">1</div>
						</div>						
						<div class="content-wrap">
							<h3 class="heading">Choose a Cloud Hosting Plan</h3>
							<div class="desc">
								Choses VPS from our list and signup. 
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="wrapper">
						<div class="img-wrap">
							<img src="img/cloud-2.jpg" alt="photo" class="img img-responsive">
							<div class="number">2</div>
						</div>						
						<div class="content-wrap">
							<h3 class="heading">Create Your Account</h3>
							<div class="desc">
								Create account by filling form 
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 clear-sm">
					<div class="wrapper">
						<div class="img-wrap">
							<img src="img/cloud-3.jpg" alt="photo" class="img img-responsive">
							<div class="number">3</div>
						</div>						
						<div class="content-wrap">
							<h3 class="heading">Get 2 Month Trial</h3>
							<div class="desc">
								If you are eligible, your free trial will start when you sign up for VPS. You will need a credit card so that we can verify your identity, but you will not be charged or billed during your free trial. 
							</div>
						</div>
					</div>
				</div>
	...
	****************** 
	...
	<div class="mofh-pricing vps-pricing">
		<div class="container no-padding-sm">
			<div class="row">
				<div class="col-sm-12">
					<div class="heading">Details of Cloud VPS</div>
					<h3 class="subheading">Features and Prices</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-4">
					<div class="wrapper">
						<div class="title">
						vps <span class="number">1</span>
						</div>
						<div class="price"><sup>$</sup>40
							<div class="period">per month</div>
						</div>
						
						<ul class="list-info">
							<li>4 GB</li>
							<li>2 DEDICATED vCPUs</li>
							<li>25GB SSD DISK</li>
							<li>4TB Disk Transfer</li>
							<li>Per Hour Cost $0.060/hr</li>
						</ul>
						<a href="https://try.digitalocean.com/cloud-hosting/" class="mofh-btn">order now</a>
					</div>
				</div> 
				<div class="col-sm-4">
					<div class="wrapper">
						<div class="title">
						vps <span class="number">2</span>
						</div>
						<div class="price"><sup>$</sup>80
							<div class="period">per month</div>
						</div>
						
						<ul class="list-info">
							<li>8 GB</li>
							<li>4 DEDICATED vCPUs</li>
							<li>50GB SSD DISK</li>
							<li>5TB Disk Transfer</li>
							<li>Per Hour Cost $0.119/hr</li>
						</ul>
						<a href="https://try.digitalocean.com/cloud-hosting/" class="mofh-btn">order now</a>
					</div>
				</div> 	
				<div class="col-sm-4">
					<div class="wrapper">
						<div class="title">
						vps <span class="number">3</span>
						</div>
						<div class="price"><sup>$</sup>160
							<div class="period">per month</div>
						</div>
						
						<ul class="list-info">
							<li>16 GB</li>
							<li>8 DEDICATED vCPUs</li>
							<li>100GB SSD DISK</li>
							<li>6TB Disk Transfer</li>
							<li>Per Hour Cost $0.238/hr</li>
						</ul>
						<a href="https://try.digitalocean.com/cloud-hosting/" class="mofh-btn">order now</a>
					</div>
				</div> 
