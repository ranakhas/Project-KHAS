...
<html lang="en">
  <head>
    ...
    <title>About KHAS Web Hosting - <?=$mofh['title'];?></title>
...
<h2>About <?=$mofh['title'];?></h2>

<hr>
					
<p>This site is launched by <?=$mofh['owner'];?> to provide Free Hosting to everyone and everywhere at Zero Cost.
</p><br>
</hr>
	...
	<h2>Mission</h2>
					<hr>
					<blockquote>
                    <p>Our Mission is to provide hosting to everyone who needs and who deserves. </p>
                </blockquote>
