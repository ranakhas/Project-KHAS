...
<html lang="en">
  <head>
    ...
    <title>Shared Hosting - <?=$mofh['title'];?></title>
...
<!-- 
	...
	*******************
	...
	<div class="mofh-hosting-plans mofh-pricing classic">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<div class="heading-section">
						Choose Web Hosting Plan Perfect for You
					</div>
					<h3 class="section-subheading small-text">
						We Have 3 Diffrent Packages Choose Perfect for You
					</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-3 col-sm-offset-3 no-padding-sm">
					<div class="wrapper first">
						...
						<a href="https://ifastnet.com/portal/cart.php?a=add&pid=78" class="mofh-btn">get started</a>
					</div>
				</div>
				<div class="col-sm-3 no-padding-sm">
					<div class="wrapper act">
						...
						<a href="https://ifastnet.com/portal/cart.php?a=add&pid=1" class="mofh-btn">get started</a>
					</div>
				</div> 
				<div class="col-sm-3 no-padding-sm">
					<div class="wrapper">
						...
						<div class="period">per month</div>
						<a href="https://ifastnet.com/portal/cart.php?a=add&pid=6" class="mofh-btn">get started</a>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12 no-padding-sm">
					<div class="table-responsive">
						<table class="table">
							<tr>
								<td class="title-table">Number of Websites</td>
								<td>1 Website</td>
								<td>20 Websites</td>
								<td>Multiple Websites</td>
							</tr>
							<tr>
								<td class="title-table" colspan="2">Free Domain Registration</td>
								<td><img src="img/check-2.png" alt="check"></td>
								<td><img src="img/check-2.png" alt="check"></td>
							</tr>
							<tr>
								<td class="title-table">Web Space</td>
								<td>5GB</td>
								<td>Unlimited</td>
								<td>Unlimited</td>
							</tr>
							...
							<tr>
								<td class="title-table" colspan="2">MySQL Databases</td>
								<td><img src="img/check-2.png" alt="check"></td>
								<td><img src="img/check-2.png" alt="check"></td>
							</tr>
							<tr>
								<td class="title-table">Free App Store</td>
								<td><img src="img/check-2.png" alt="check"></td>
								<td><img src="img/check-2.png" alt="check"></td>
								<td><img src="img/check-2.png" alt="check"></td>
							</tr>
							<tr>
								<td class="title-table" colspan="2">Panel Control Panel</td>
								<td><img src="img/check-2.png" alt="check"></td>
								<td><img src="img/check-2.png" alt="check"></td>
							</tr>
							<tr>
								<td class="title-table">Free Daily Backups</td>
								<td><img src="img/check-2.png" alt="check"></td>
								<td><img src="img/check-2.png" alt="check"></td>
								<td><img src="img/check-2.png" alt="check"></td>
							</tr>
