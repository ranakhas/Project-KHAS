...
<html lang="en">
  <head>
    ...
    <title>F.A.Q. Section - <?=$mofh['title'];?></title>
...
<!-- 
				...
				<div class="col-sm-12">
					<div class="wrapper">
						...
						<div class="subheding">
							...
							<a href="about.php" class="link active">F.A.Q.</a>
						</div>
					</div>
				</div>
			</div>
	...
	*******************
	...
	<div class="mofh-question">
		<div class="container no-padding-sm">
			<div class="row">
				<div class="col-sm-12">
					<div class="heading">
						submit your <br> <span class="large-text">questions</span>
					</div>
				</div>
			</div>
			<form action="mailto:<?=$mofh['email'];?>" method="post" class="mofh-comments-form light">
				<div class="row">
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-12 text-xs-center">
						<textarea name="ask" placeholder="Ask your question here..." class="input textarea"></textarea>
						<input type="submit" class="mofh-btn submit" value="submit">
					</div>
				</div>
			</form>
		</div>
