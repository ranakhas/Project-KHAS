...
<html lang="en">
  <head>
    ...
    <title>Our Team - <?=$mofh['title'];?></title>
...
<!-- 
	...
	****************** 
				...
				<div class="col-sm-12">
					<div class="wrapper">
						...
						<div class="subheding">
							...
							<a href="team.php" class="link active">Our team</a>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="mofh-team-about classic">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
			...
			<div class="row">
				<div class="col-lg-3 col-sm-6">
					<div class="wrapper">										
						<img src="img/team-4.jpg" alt="photo" class="img-team">
						<div class="more-info">
							<div class="title">
								Nemo enim ipsam <br> voluptatem quia voluptas 
							</div>
							<div class="desc">
					...
					<div class="subheading">Director / Founder</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="wrapper">										
						<img src="img/team-5.jpg" alt="photo" class="img-team">
						<div class="more-info">
							<div class="title">
								Nemo enim ipsam <br> voluptatem quia voluptas 
							</div>
					...
					<div class="heading">SuperMan </div>
					<div class="subheading">Director / Founder</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="wrapper">										
						<img src="img/team-6.jpg" alt="photo" class="img-team">
						<div class="more-info">
							<div class="title">
								Nemo enim ipsam <br> voluptatem quia voluptas 
							</div>
					...
					<div class="heading">Wonder Woman </div>
					<div class="subheading">Director / Founder</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="wrapper">										
						<img src="img/team-7.jpg" alt="photo" class="img-team">
						<div class="more-info">
							<div class="title">
								Nemo enim ipsam <br> voluptatem quia voluptas 
							</div>
